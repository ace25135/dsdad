...
if (isset($accessToken)) {
	...
	try {
		...
		if ($e->getCode() == 190) {
			...
			$loginUrl = $helper->getLoginUrl('https://apps.facebook.com/goodgoodeateateat/', $permissions);
	...
	$helper = $fb->getRedirectLoginHelper();
	$loginUrl = $helper->getLoginUrl('https://apps.facebook.com/goodgoodeateateat/');
	echo "<script>window.top.location.href='".$loginUrl."'</script>";
}